...
```
npm create cloudflare@latest -- --template=cloudflare/templates/taslabs-globe
```

A live public deployment of this template is available at [https://taslabs-globe.templates.workers.dev](https://taslabs-globe.templates.workers.dev)
